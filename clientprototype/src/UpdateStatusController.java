...
public class UpdateStatusController implements Initializable, ChatIF {
	...
	public void findReader(ActionEvent event) throws Exception {
		...
		Pane root = loader.load(getClass().getResource("GUI_FXML/FindReader.fxml").openStream());
	...
	public void start(Stage primaryStage) throws IOException {
		...
		Parent root = FXMLLoader.load(getClass().getResource("GUI_FXML/UpdateStatus.fxml"));
		Scene scene = new Scene(root);
